...
var burgerIcon = document.getElementById("hamburger-slim");
var menuMobile = document.getElementById("menu-mobile");
var searchButton = document.getElementById("search-button");
var searchInput = document.getElementById("search-input");
var searchInputButton = document.getElementById("search-input-button");
var searchMobile = document.getElementById("search-mobile");
var body = document.getElementById("body");
var openFilter = document.getElementById("open-filter");
var selectGroup = document.getElementById("select-group");
var selectGroupContainer = document.getElementById("select-group__container");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  scrollButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      var targetSection = document.querySelector("#services");
      if (targetSection) {
...
/***/ "./src/blocks/modules/leave-comment/leave-comment.js":
/*!***********************************************************!*\
  !*** ./src/blocks/modules/leave-comment/leave-comment.js ***!
  \***********************************************************/
/***/ (() => {
...
var modalBgClass = document.getElementsByClassName("modal-bg");
var modalBg = document.getElementById("modal-bg");
var modals = document.getElementsByClassName("modal");
var body = document.getElementById("body");
var closeModalElements = document.getElementsByClassName("modal__close");
for (var i = 0; i < closeModalElements.length; i++) {
  closeModalElements[i].addEventListener("click", function (e) {
    e.preventDefault();
...
for (var _i = 0; _i < modalBgClass.length; _i++) {
  modalBgClass[_i].addEventListener("click", function (e) {
    e.preventDefault();
    for (var j = 0; j < modals.length; j++) {
      modals[j].classList.remove("opened");
    }
...
leftComplaint === null || leftComplaint === void 0 || leftComplaint.addEventListener("click", function (e) {
  e.preventDefault();
  modalAddComplaint.classList.add("opened");
  modalBg.classList.add("opened");
  body.classList.add("opened");
});
leftComplaintMob === null || leftComplaintMob === void 0 || leftComplaintMob.addEventListener("click", function (e) {
  e.preventDefault();
  modalAddComplaint.classList.add("opened");
  modalBg.classList.add("opened");
  body.classList.add("opened");
});
for (var _i2 = 0; _i2 < closeModalElements.length; _i2++) {
  var _addService$_i;
  (_addService$_i = addService[_i2]) === null || _addService$_i === void 0 || _addService$_i.addEventListener("click", function (e) {
    e.preventDefault();
...
/***/ "./src/blocks/modules/one-service/service-navigation.js":
/*!**************************************************************!*\
  !*** ./src/blocks/modules/one-service/service-navigation.js ***!
  \**************************************************************/
/***/ (() => {

var openNavigation = document.getElementById("open-navigation");
var serviceNavigation = document.getElementById("service-navigation");
openNavigation === null || openNavigation === void 0 || openNavigation.addEventListener("click", function (e) {
  e.preventDefault();
    ...
    if (h2Elements.length > 0) {
      h2Elements.forEach(function (h2Element, index) {
        ...
        newAElement.addEventListener('click', function (event) {
          event.preventDefault();
          var h2Rect = h2Element.getBoundingClientRect();
          window.scrollTo({
...
/* harmony import */ var _modules_filter_filter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! %modules%/filter/filter */ "./src/blocks/modules/filter/filter.js");
/* harmony import */ var _modules_filter_filter__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modules_filter_filter__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modules_leave_comment_leave_comment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! %modules%/leave-comment/leave-comment */ "./src/blocks/modules/leave-comment/leave-comment.js");
/* harmony import */ var _modules_leave_comment_leave_comment__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_leave_comment_leave_comment__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_one_service_service_navigation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! %modules%/one-service/service-navigation */ "./src/blocks/modules/one-service/service-navigation.js");
/* harmony import */ var _modules_one_service_service_navigation__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_one_service_service_navigation__WEBPACK_IMPORTED_MODULE_3__);
...
// import "%modules%/service-rating/service-rating";
